...
png('plot1.png', width = w, height = h, units = 'px')
hist(as.numeric(interesting_data$Global_active_power), col = 'red', main = 'Global Active Power', xlab = 'Global Active Power (kilowatts)')
dev.off()
